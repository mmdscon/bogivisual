        ...
        <div className="mx-auto max-w-6xl grid lg:grid-cols-2 gap-14 items-center">
          ...
          <div className="max-w-xl">
            ...
            <h1 className="mt-5 text-3xl sm:text-4xl font-semibold tracking-tight leading-[1.05]">
              Geschafft – wir sehen uns bald.
            </h1>

            <p className="mt-4 text-base text-black/70 leading-relaxed">
              Ihr Termin wurde erfolgreich gebucht. Sie erhalten in Kürze eine
              Bestätigung per E-Mail mit allen Details sowie einem Link, falls
              Sie den Termin verschieben möchten. Ich freue mich auf unser
              Gespräch.
            </p>
